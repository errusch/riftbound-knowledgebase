...
- Verified guides now use a strict-proof, split-claims model: only structured summary claims may drive retrieval snippets, while weaker topics stay visible as unsupported or attributed context.
