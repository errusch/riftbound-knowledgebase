...
source_path: /Users/eric/claude-workspace/riftbound/rule-documents/tournament-rules.txt
...
## Import Notes
- Imported at: `2026-03-27T18:55:52.519274Z`
- Extraction status: `ok`

## Source Files
- `assets/official/rule-documents/[Official] Riftbound Rules - Tournament Rules (2025-10-16).docx`
- `assets/official/rule-documents/tournament-rules.txt`
...
419.4.c. Contain oensive images or text.
...
422.2.a. It’s suggested but not required that players use dierent sleeves for the dierent decks (Main, Rune).
422.3. Sleeves must have opaque backs.
422.4. During a match, a player may request that a judge inspect an opponent’s sleeves.
422.5. Judges may disallow any specific sleeve or the sleeves generally if they believe they are marked, worn, inappropriate, oensive, or otherwise interfere with shuing or play.
...
424.2. Players are responsible for making reasonable eort to prevent secret information from being revealed accidentally. See CR 127. Privacy for information types.
...
702.8.b.1.b. If overpaying a cost caused a result that Riftbound Tournament Rules
Rules, responsibilities and procedures to be followed in all Riftbound competitions.
Rules and Releases
10/16/2025
100. Introduction
...
704.8.d. The head judge has ultimate discretion to issue penalties for cheating.would not otherwise have happened, it is a General Error. See 702.15 for more information about General Errors.
702.9. Mispayment for Cost [Warning]: A player pays a cost underpaying its power or energy cost, or uses the incorrect domain to pay a power cost.
702.9.a. Errors of this sort are generally public, and all players are expected to be mindful of game state.
702.9.b. Remedies:
702.9.b.1. Perform a simple rewind if possible, to the moment before the card was played.
