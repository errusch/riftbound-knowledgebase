# Riftbound — Current Meta Digest

_Generated 2026-04-16 from 11 canonical events and 176 decklists. Source of truth is this KB; do not cite outside it without flagging._
...
### S tier
- **Draven** — 24 top-8 placements (35.3% of tracked top 8s)
- **Irelia** — 11 top-8 placements (16.2% of tracked top 8s)

### A tier
- **Annie** — 7 top-8 placements (10.3% of tracked top 8s)
- **Kai'Sa** — 7 top-8 placements (10.3% of tracked top 8s)

### B tier
- **Ezreal** — 5 top-8 placements (7.4% of tracked top 8s)
- **Master Yi** — 3 top-8 placements (4.4% of tracked top 8s)

### C tier
- **Jax** — 2 top-8 placements (2.9% of tracked top 8s)
- **Viktor** — 2 top-8 placements (2.9% of tracked top 8s)
- **Sivir** — 2 top-8 placements (2.9% of tracked top 8s)
- **Miss Fortune** — 1 top-8 placements (1.5% of tracked top 8s)
- **Garen** — 1 top-8 placements (1.5% of tracked top 8s)
- **Sett** — 1 top-8 placements (1.5% of tracked top 8s)
- **Fiora** — 1 top-8 placements (1.5% of tracked top 8s)
- **Azir** — 1 top-8 placements (1.5% of tracked top 8s)
...
- 4: LineKa·小XO on null  `decklists/shenzhen-national-open-2026-03-22---4.json`
- 5: 宝库卡牌-andy1996 on null  `decklists/shenzhen-national-open-2026-03-22---5.json`
- 6: 神切.KDX.克烈同学 on null  `decklists/shenzhen-national-open-2026-03-22---6.json`
...
- Cite any tournament claim against a specific row in this file or the underlying decklist/event JSON.
- When claims here conflict with an article draft, the KB wins; update the article.
- When the KB is silent on something, say "no KB coverage yet" instead of inventing it.
- Regenerate with `node scripts/regen-current-meta.mjs` after editing events/decklists.
